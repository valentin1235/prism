...
prism_psm_define_command_config "analyze" "skill_description" "Runs multi-perspective analysis via MCP server orchestration. Thin Codex wrapper over the shared Prism analyze skill."
prism_psm_define_command_config "analyze" "skill_version" "7.1.0"
