...
→ Apply `../shared-v1/perspective-quality-gate.md` with skill-appropriate `{DOMAIN}` and `{EVIDENCE_SOURCE}`.
...
→ Read and execute `../shared-v1/ontology-scope-mapping.md` with:
