...
- `{ONTOLOGY_SCOPE}` — full-pool ontology docs scope from Phase 0.7, or "N/A" if unavailable
...
- When referencing ontology docs, cite as "filename:section".
...
- {list of ontology docs read, or "N/A — no ontology docs assigned"}
